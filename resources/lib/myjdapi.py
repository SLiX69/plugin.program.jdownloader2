...
class System:
    ...
    def help(self):
        ...
        :return:
        """
        resp = self.device.action(self.url + "/help")
        return resp
...
class DownloadController:
    ...
    def force_download(self, link_ids, package_ids):
        """
        Force to download a package and/or links
        :param link_ids:
        :param package_ids:
        :return:
        """
    ...
    def get_current_state(self):
        """
        Get the current downloading state of JD
        :return:
        """
...
class Linkgrabber:
    ...
    def rename_link(self, link_id, new_name):
        ...
        resp = self.device.action("/linkgrabberv2/renameLink", params)
        return resp
    ...
    def query_packages(self, params=[
        ...
        """
        Get the packages in the linkgrabber list
        """
